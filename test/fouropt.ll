...
define dso_local i32 @foo(i32) #0 {
  ...
  call void asm sideeffect "bndmk ($0, $1), %bnd0", "r,~{dirflag}, ~{fpsr}, ~{flags}"(i8* %9, i8 0)
  %10 = bitcast i32 (i32, i32)** %4 to i8*
  store i32 (i32, i32)* @sub, i32 (i32, i32)** %4, align 8
  call void asm sideeffect "bndmk ($0, $1), %bnd1", "r,~{dirflag}, ~{fpsr}, ~{flags}"(i8* %10, i8 1)
...
20:                                               ; preds = %17
  ...
  %24 = bitcast i32 (i32, i32)** %4 to i8*
  call void asm sideeffect "bndcl ($0), %bnd1", "r,~{dirflag}, ~{fpsr}, ~{flags}"(i8* %24)
  %25 = call i32 %21(i32 %22, i32 %23)
